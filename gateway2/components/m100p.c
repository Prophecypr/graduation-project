...
{
    const char *device_secret = "e026171a3785bb831abe5815482c0852";
    const char *product_key = "hk8yVDm91aS";
    const char *device_name = "esp32c3_4g_gateway_2";
...
void MQTT_cloud_data_forwarding(int mode,int temperature,int humidity)
{
    ...
    "AT+MPUB=\"/hk8yVDm91aS/esp32c3_4g_gateway_2/user/temperature/update\",0,0,\"%i.%i\"\r", temperature/10,temperature%10);
    sendStringData(TAG,cmd_temperature);
    vTaskDelay(100 / portTICK_PERIOD_MS);
    snprintf(cmd_humidity, sizeof(cmd_humidity), 
    "AT+MPUB=\"/hk8yVDm91aS/esp32c3_4g_gateway_2/user/humidity/update\",0,0,\"%i\"\r", humidity);
    sendStringData(TAG,cmd_humidity);
    vTaskDelay(100 / portTICK_PERIOD_MS);
    snprintf(cmd_mode, sizeof(cmd_mode), 
    "AT+MPUB=\"/hk8yVDm91aS/esp32c3_4g_gateway_2/user/mode/update\",0,0,\"%i\"\r", mode);
...
int m100p_init()
{
    ...
    if (send_command_and_wait("AT+MSUB=\"/hk8yVDm91aS/esp32c3_4g_gateway_2/user/mode/update\",0\r")) {
